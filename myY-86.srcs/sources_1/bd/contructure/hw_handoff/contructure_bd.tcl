...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net MREG_0_M_icode [get_bd_pins MREG_0/M_icode] [get_bd_pins WREG_0/icode] [get_bd_pins control_0/M_icode] [get_bd_pins memOperation_0/icode] [get_bd_pins selectPC_0/M_icode]
  connect_bd_net -net MREG_0_M_stat [get_bd_pins MREG_0/M_stat] [get_bd_pins m_stat_0/stat]
